...
-- tabs
vim.keymap.set("n", "<leader>wx", function() vscode.call "workbench.action.closeActiveEditor" end, { silent = true })
vim.keymap.set("n", "<tab>n", function() vscode.call "workbench.action.nextEditorInGroup" end, { silent = true })
vim.keymap.set("n", "<tab>p", function() vscode.call "workbench.action.previousEditorInGroup" end, { silent = true })
...
-- [b]uffer [c]lose except active
vim.keymap.set("n", "<leader>bc", function() vscode.call "workbench.action.closeOtherEditors" end, { silent = true })
...
vim.keymap.set("n", "<leader>ff", function() vscode.call "workbench.action.quickOpen" end, { silent = true })
...
vim.keymap.set("n", "gr", function() vscode.call "editor.action.goToReferences" end, { silent = true })

-- go to link
vim.keymap.set("n", "<leader>gl", function() vscode.call "editor.action.openLink" end, { silent = true })
...
vim.keymap.set(
  "n",
  "<leader>lg",
  function() vscode.call("workbench.scm.focus", { args = { "scmInput" } }) end,
  { silent = true }
)
...
vim.keymap.set("n", "<leader>rn", function() vscode.call "editor.action.rename" end, { silent = true })
